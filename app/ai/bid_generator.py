    ...
    def _build_messages(
        ...
        target_payload = {
            ...
            "instructions": (
                ...
                "нет конкретного ТЗ — убери строку цены/сроков целиком (никаких незаполненных {price}/{deadline}). "
                ...
                "немає конкретного ТЗ — прибери рядок ціни/термінів цілком (жодних незаповнених {price}/{deadline}). "
